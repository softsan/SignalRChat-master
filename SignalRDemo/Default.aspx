...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <style type="text/css">
     ...
     <div id="divContainer">
        <div id="divLogin" class="login1">
            <div>
                Your Name:<br />
                <input id="txtNickName" type="text" class="textBox" />
            </div>
            <div id="divButton">
                <input id="btnStartChat" type="button" class="submitButton" value="Login" />
            </div>
        </div>
         <div id="divLogout" class="login1">
             <input id="btnLogout" type="button" class="submitButton" value="Logout" />
          </div>
    ...
    <script type="text/javascript">
        ...
        function registerEvents(chatHub) {
            ...
            $("#txtMessage").keypress(function (e) {
                if (e.which == 13) {
                    ...
                    chatHub.server.isTyping(encodedName);
                }
            });
        ...
        function registerClientMethods(chatHub) {
            ...
            chatHub.client.sayWhoIsTyping = function (name) {
                ...
                $('#isTyping').html('<em>' + name + ' is typing...</em> ' + $("#txtMessage").val());
                setTimeout(function () {
                    $('#isTyping').html('&nbsp;');
                }, 5000);
            };
